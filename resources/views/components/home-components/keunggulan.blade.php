...
{{-- Keunggulan Section dengan desain yang lebih maksimal dan modern --}}
                    ...
                    <div class="mb-8 relative z-10 flex justify-center w-full">
                      ...
                      <div class="relative inline-flex">
                        ...
                        <div class="w-20 h-20 bg-gradient-to-br from-white to-blue-50 rounded-full flex items-center justify-center relative border border-white shadow-lg group-hover:shadow-blue-300/30">
                          @if(!empty($item->image))
                            <img src="{{ asset('storage/' . $item->image) }}" alt="{{ $item->title }}" class="w-10 h-10 transform group-hover:scale-110 transition-transform">
                          @else
                            @php
                              $iconClasses = [
                            ...
                            @endphp
                            <i class="fas {{ $iconClass }} text-transparent bg-clip-text bg-gradient-to-br {{ $iconColor }} text-2xl transform group-hover:scale-125 transition-transform"></i>
                          @endif
                        </div>
                      </div>
                    </div>
