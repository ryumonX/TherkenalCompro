      ...
      @empty
        @for($i = 0; $i < 3; $i++)
          <div class="bg-white rounded-xl shadow-md overflow-hidden group transition duration-300 hover:shadow-xl relative">
            ...
            <div class="h-64 overflow-hidden relative">
              <div
                ...
                @click="
                  openModal = true;
                  selectedProduct = {
                    title: 'Atap Metal Premium {{ ['Blue', 'Red', 'Green'][$i] }}',
                    ...
                    image: 'https://readdy.ai/api/search-image?query=high%20quality%20metal%20roofing%20tiles%20in%20{{ ['blue', 'red', 'green'][$i] }}%20color%2C%20detailed%20texture%20of%20modern%20roofing%20material%20against%20white%20background%2C%20professional%20product%20photography%20of%20construction%20materials&width=400&height=300&seq=product{{ $i+1 }}&orientation=landscape'
                  }
                "
              >
                <div class="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              ...
              <img
                src="https://readdy.ai/api/search-image?query=high%20quality%20metal%20roofing%20tiles%20in%20{{ ['blue', 'red', 'green'][$i] }}%20color%2C%20detailed%20texture%20of%20modern%20roofing%20material%20against%20white%20background%2C%20professional%20product%20photography%20of%20construction%20materials&width=400&height=300&seq=product{{ $i+1 }}&orientation=landscape"
                alt="Atap Metal Premium {{ $i+1 }}"
                class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              />
            </div>
            ...
            <div class="p-6 relative">
              <h3 class="text-xl font-bold text-gray-800 mb-3">
                Atap Metal Premium {{ ['Blue', 'Red', 'Green'][$i] }}
                <div class="h-0.5 w-12 bg-gradient-to-r from-blue-500 to-cyan-400 mt-2 group-hover:w-full transition-all duration-300"></div>
              </h3>
              ...
              <a href="https://wa.me/{{ $kontak ? preg_replace('/[^0-9]/', '', $kontak->no_telepon) : '6281234567890' }}?text=Halo%2C%20saya%20tertarik%20dengan%20produk%20*{{ urlencode('Atap Metal Premium ' . ['Blue', 'Red', 'Green'][$i]) }}*%20yang%20ada%20di%20website%20Anda.%20Mohon%20informasi%20lebih%20lanjut.%20Terima%20kasih."
                 target="_blank"
                 class="block w-full">
      ...
      >
        ...
        <div class="flex flex-col lg:flex-row max-h-[90vh]">
          ...
          <div class="w-full lg:w-1/2 p-6 lg:p-8 flex flex-col max-h-[90vh] lg:max-h-none">
            ...
            <a :href="`https://wa.me/{{ $kontak ? preg_replace('/[^0-9]/', '', $kontak->no_telepon) : '6281234567890' }}?text=Halo%2C%20saya%20tertarik%20dengan%20produk%20*${selectedProduct.title}*%20yang%20ada%20di%20website%20Anda.%20Mohon%20informasi%20lebih%20lanjut.%20Terima%20kasih.`"
               target="_blank"
               class="block w-full">
              <button class="w-full group relative overflow-hidden px-6 py-3 rounded-lg font-bold text-white bg-gradient-to-r from-blue-600 to-blue-500 shadow-lg hover:shadow-blue-500/30">
                <span class="relative z-10 flex items-center justify-center">
