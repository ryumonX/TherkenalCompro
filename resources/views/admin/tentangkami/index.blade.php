                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        @if($tentangKami->image)
                            <div class="mt-2 mb-3">
                                <img src="{{ asset('storage/' . $tentangKami->image) }}" alt="Gambar Tentang Kami"
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $tentangKami->title) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $tentangKami->subtitle) }}"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        @error('subtitle')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea id="editor" name="description" class="mt-1 block w-full border border-gray-300 rounded min-h-[400px]">{{ old('description', $tentangKami->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
    ...
    <div class="mt-6 bg-white shadow rounded-lg">
        ...
        <div class="p-6">
            <div class="prose max-w-none">
                <h2 class="text-2xl font-bold text-gray-800" id="preview-title">{{ $tentangKami->title }}</h2>
                <h2 class="text-2xl font-bold text-gray-800" id="preview-subtitle">{{ $tentangKami->subtitle }}</h2>
