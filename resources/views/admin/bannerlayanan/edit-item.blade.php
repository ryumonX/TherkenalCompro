...
@section('content')
    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b">
            ...
            <a href="{{ route('admin.banner-layanan.index') }}"
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <a href="#" onclick="showImagePreview('{{ asset('storage/'.$item->image_icon) }}', '{{ $item->title }}'); return false;">
                        <img src="{{ asset('storage/'.$item->image_icon) }}" alt="{{ $item->title }}"
                ...
                {{-- Form Edit --}}
                <div>
                    <form action="{{ route('admin.banner-layanan.item.update', $item) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
