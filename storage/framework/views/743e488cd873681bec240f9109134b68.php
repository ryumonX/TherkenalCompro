      ...
      <div class="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10 py-12 lg:py-16">
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-20">
          ...
          <div class="lg:w-3/5 relative">
            <?php if(count($keunggulanItems) > 0): ?>
              <?php $currentItem = $keunggulanItems[0]; ?>
              ...
              <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-8 lg:p-12 relative z-10 hover:shadow-2xl transition-all duration-500 group">
                ...
                <div class="relative z-10">
                  ...
                  <h3 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-6 leading-tight">
                    <?php echo e($currentItem->title ?? 'Kualitas layanan kami adalah yang terdepan.'); ?>

                  </h3>

                  <!-- Description -->
                  <p class="text-gray-600 text-lg mb-8 leading-relaxed">
                    <?php echo e($currentItem->subtitle ?? 'Solusi terbaik dengan kualitas premium dan pelayanan yang memuaskan setiap pelanggan.'); ?>
                    ...
                    <div class="flex items-center space-x-4">
                      ...
                      <div class="flex-shrink-0 relative">
                        <?php if(!empty($currentItem->image)): ?>
                          <img src="<?php echo e(asset('storage/' . $currentItem->image)); ?>" alt="Customer" class="w-14 h-14 rounded-full object-cover border-2 border-white shadow-lg">
                        <?php else: ?>
              ...
              <?php if(count($keunggulanItems) > 1): ?>
                <div class="flex items-center justify-center space-x-4 mt-8">
                  ...
                  <div class="flex space-x-2">
                    <?php $__currentLoopData = $keunggulanItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <button class="testimonial-dot w-3 h-3 rounded-full transition-all duration-300 <?php echo e($index === 0 ? 'bg-emerald-500' : 'bg-gray-300 hover:bg-gray-400'); ?>" data-index="<?php echo e($index); ?>"></button>
              ...
              <?php if(count($keunggulanItems) > 1): ?>
                <div class="mt-6 bg-gray-200 rounded-full h-1 overflow-hidden">
                  <div class="testimonial-progress bg-gradient-to-r from-emerald-500 to-green-500 h-1 rounded-full transition-all duration-500 ease-out" style="width: <?php echo e(100 / count($keunggulanItems)); ?>%"></div>
                </div>
              <?php endif; ?>
              ...
              <div class="hidden" id="keunggulan-data">
                <?php $__currentLoopData = $keunggulanItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="keunggulan-item" data-index="<?php echo e($index); ?>">
                    <div class="title"><?php echo e($item->title); ?></div>
                    <div class="subtitle"><?php echo e($item->subtitle); ?></div>
                    <div class="image"><?php echo e(!empty($item->image) ? asset('storage/' . $item->image) : ''); ?></div>
                  </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
            <?php else: ?>
