...
$navGroups = [
    ...
    'KONTEN BERANDA' => [
        ...
        ['label' => 'Partner', 'route' => 'admin.partner.index', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />'],
    ],
    ...
    <div class="h-16 border-b border-gray-200 flex items-center justify-between px-4">
        ...
        <div class="sidebar-logo overflow-hidden">
            <?php if($configWeb && $configWeb->logo): ?>
                <img src="<?php echo e(asset('storage/' . $configWeb->logo)); ?>" alt="Logo Admin" class="h-10 object-contain sidebar-content">
            <?php else: ?>
                    ...
                    >
                        <div class="space-y-1 py-1">
                            <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                >
                                    <span class="text-sm mr-2"><?php echo e($link['label']); ?></span>
...
<?php /**PATH C:\Users\lenovo\Documents\TherkenalCompro\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>