...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['artikel' => [], 'kategoriArtikel' => [], 'socialMedia' => []]));
...
foreach (array_filter((['artikel' => [], 'kategoriArtikel' => [], 'socialMedia' => []]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
    ...
    <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
      ...
      <div class="lg:w-2/3">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <?php $__empty_1 = true; $__currentLoopData = $artikel->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      ...
      <div class="lg:w-1/3 space-y-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 relative backdrop-blur-sm bg-opacity-90 border border-gray-100">
          ...
          <ul class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $kategoriArtikel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <li class="group">
                <a href="<?php echo e(route('artikel.index', ['kategori' => $kategori->slug])); ?>" class="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-blue-50 transition-all">
                  <div class="flex items-center">
                    ...
                    <span class="text-gray-600 group-hover:text-blue-700 transition-colors"><?php echo e($kategori->title); ?></span>
                  </div>

                  <!-- Counter badge -->
                  <?php if(isset($kategori->artikel)): ?>
                    <span class="bg-gray-100 text-gray-600 group-hover:bg-blue-100 group-hover:text-blue-700 text-xs px-2 py-1 rounded-full transition-colors">
                      <?php echo e($kategori->artikel->count()); ?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $socialMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <a href="<?php echo e($social->link_platform); ?>" class="group" target="_blank">
                <div class="relative">
                  ...
                  <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-300 relative p-2 transform transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg">
                    <img
                      src="<?php echo e(asset('storage/' . $social->images->first()->image)); ?>"
                      alt="<?php echo e($social->platform); ?>"
...
</section><?php /**PATH C:\Users\lenovo\Documents\company_profile\resources\views/components/home-components/artikel-home.blade.php ENDPATH**/ ?>