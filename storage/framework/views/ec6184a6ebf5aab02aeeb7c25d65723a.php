            ...
            <?php $__empty_1 = true; $__currentLoopData = $displayArtikel->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <a href="<?php echo e(route('artikel.detail', $post->slug)); ?>" class="group flex gap-3 p-2 rounded-lg hover:bg-gray-800 transition-colors duration-300">
                <div class="flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden">
                  <img src="<?php echo e(asset('storage/' . $post->thumbnail)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                </div>
                <div class="flex-grow min-w-0">
                  <h4 class="font-medium text-sm text-white truncate"><?php echo e($post->title); ?></h4>
...
<?php /**PATH C:\Users\lenovo\Documents\TherkenalCompro\resources\views/components/home-components/footer.blade.php ENDPATH**/ ?>