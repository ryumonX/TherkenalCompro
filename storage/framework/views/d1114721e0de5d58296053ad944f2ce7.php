...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['artikel', 'kategoriArtikel' => [],'artikelTerkait' => [], 'artikelTerbaru' => []]));
...
foreach (array_filter((['artikel', 'kategoriArtikel' => [],'artikelTerkait' => [], 'artikelTerbaru' => []]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
  ...
  <div class="container mx-auto px-4 lg:px-0 relative z-10">
    ...
    <header class="mb-16 px-4 lg:px-10">
      ...
      <nav class="flex items-center text-sm text-gray-500 mb-8 bg-white py-2 px-4 rounded-lg shadow-sm">
        <a href="<?php echo e(route('home')); ?>" class="hover:text-blue-600 transition-colors flex items-center">
        ...
        <a href="<?php echo e(route('artikel.index')); ?>" class="hover:text-blue-600 transition-colors">Artikel</a>
        <div class="mx-2 text-gray-400">/</div>
        <span class="text-gray-900 font-medium truncate max-w-[200px] sm:max-w-xs"><?php echo e($artikel->title); ?></span>
      </nav>

      <!-- Category & Date -->
      <div class="flex flex-wrap items-center gap-4 mb-6">
        <?php if($artikel->kategori): ?>
        <a href="<?php echo e(route('artikel.index', ['kategori' => $artikel->kategori->slug])); ?>" class="group">
          <span class="inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-700 rounded-full text-sm font-medium group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
            ...
            <?php echo e($artikel->kategori->title); ?>
        ...
        <time class="text-gray-500 text-sm flex items-center bg-gray-100 px-3 py-1.5 rounded-full">
          ...
          <?php echo e($artikel->post_schedule->format('d F Y')); ?>
      ...
      <p class="text-xl text-gray-600 leading-relaxed border-l-4 border-blue-500 pl-4 py-2 bg-blue-50 rounded-r-lg italic">
        <?php echo e($artikel->preview_description); ?>
    ...
    <div class="flex flex-col-reverse lg:flex-row">
      ...
      <div class="w-full lg:w-[calc(100%-20rem)] lg:pr-10">
        ...
        <div class="mb-10 ml-0 md:ml-12 max-w-5xl rounded-2xl overflow-hidden shadow-xl relative">
          <img
            src="<?php echo e(asset('storage/' . $artikel->thumbnail)); ?>"
          ...
          <div class="absolute bottom-0 left-0 right-0 p-4 text-white text-sm">
            <div class="flex justify-between items-end">
              <p><?php echo e($artikel->title); ?></p>
              <span class="bg-black/50 px-2 py-1 rounded text-xs backdrop-blur-sm"><?php echo e($configWeb->title ?? 'Foto'); ?></span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg ml-4 p-6 sm:p-10 mb-16 relative">
          ...
          <div class="mt-12 pt-6 border-t border-gray-100">
            ...
            <div class="flex flex-wrap gap-2">
              <?php $__currentLoopData = explode(',', $artikel->meta_keyword); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mb-16 ml-0 lg:ml-8">
          <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('artikel.index')); ?>" class="text-blue-600 font-medium flex items-center hover:text-blue-800 transition-colors">
              Lihat Semua Artikel
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-xl transition-all duration-300 h-full flex flex-col">
              <div class="relative h-48 overflow-hidden">
                ...
                <?php if($terkait->kategori): ?>
                  <div class="absolute top-4 left-0 z-10">
                    <span class="bg-blue-600 text-white text-xs font-bold px-3 py-1.5 rounded-r-full shadow-md">
                      <?php echo e($terkait->kategori->title); ?>
                ...
                <img
                  src="<?php echo e(asset('storage/' . $terkait->thumbnail)); ?>"
                  alt="<?php echo e($terkait->title); ?>"
                ...
                <div class="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-md flex items-center z-20 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                  ...
                  <span class="text-gray-800 text-sm font-medium"><?php echo e($terkait->post_schedule->format('d F Y')); ?></span>
                </div>
              </div>

              <div class="p-6 flex flex-col flex-grow">
                <h4 class="text-xl font-bold text-gray-800 mb-3 line-clamp-2 group-hover:text-blue-700 transition-colors">
                  <a href="<?php echo e(route('artikel.detail', $terkait->slug)); ?>" class="hover:text-blue-600">
                    <?php echo e($terkait->title); ?>

                  </a>
                </h4>

                <p class="text-gray-600 text-sm line-clamp-3 flex-grow">
                  <?php echo e($terkait->preview_description); ?>

                </p>

                <div class="mt-4">
                  <a href="<?php echo e(route('artikel.detail', $terkait->slug)); ?>" class="inline-flex items-center text-blue-600 font-semibold group/link relative">
      ...
      <div class="w-full lg:w-96 pr-10 space-y-8 mb-10 lg:mb-0 lg:sticky lg:top-24 lg:self-start">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 relative backdrop-blur-sm bg-opacity-90 border border-gray-100">
          ...
          <ul class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $kategoriArtikel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <li class="group">
        ...
        <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl shadow-lg p-6 text-white relative overflow-hidden">
          ...
          <div class="relative">
            ...
            <?php if(isset($kontak) && $kontak): ?>
              <a href="<?php echo e(route('kontak')); ?>" class="inline-flex items-center text-white bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                Hubungi Kami
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
...
<?php /**PATH D:\coding\Therkenal\therkenal\resources\views/components/home-components/artikel-detail.blade.php ENDPATH**/ ?>