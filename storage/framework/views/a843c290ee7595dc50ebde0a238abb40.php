<nav id="mainNav" class="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md shadow-md z-50 transition-all duration-500">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center transition-all duration-500">
        <!-- Logo & Brand -->
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-4 group relative z-10">
            <?php if($configWeb && $configWeb->logo): ?>
                <img src="<?php echo e(asset('storage/' . $configWeb->logo)); ?>"
        ...
        <div class="hidden md:flex items-center gap-1 lg:gap-3">
                        ...
                        <div class="absolute top-full left-0 mt-1 w-56 bg-white rounded-lg shadow-lg border border-gray-100 opacity-0 translate-y-2 pointer-events-none transition-all duration-300 group-hover/dropdown:opacity-100 group-hover/dropdown:translate-y-0 group-hover/dropdown:pointer-events-auto">
                            <div class="py-2 px-3">
                                <?php $__currentLoopData = $nav['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e($item['route']); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-md transition-colors">
            ...
            <!-- CTA Button -->
            <a href="<?php echo e(route('kontak')); ?>" class="ml-2 lg:ml-4 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg shadow-sm hover:shadow-blue-500/20 transition-all duration-300 transform hover:-translate-y-0.5">
                Hubungi Kami
            </a>
        </div>
    ...
    <div id="mobileMenu" class="fixed inset-0 top-0 left-0 w-full h-screen bg-gradient-to-br from-blue-600/95 to-blue-800/95 backdrop-blur-md z-50 flex flex-col justify-between transform translate-x-full transition-all duration-500 md:hidden overflow-auto">
                    ...
                    <?php if($nav['submenu']): ?>
                        <div class="mobile-dropdown">
                            ...
                            <div class="mobile-dropdown-content hidden pl-4 mt-2 space-y-2">
                                <?php $__currentLoopData = $nav['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e($item['route']); ?>" class="block text-white/80 hover:text-white text-lg px-4 py-2 rounded-xl hover:bg-white/10 transition-colors">
                                        <?php echo e($item['label']); ?>
        ...
        <div class="p-6 border-t border-white/10">
            <div class="flex flex-col items-center space-y-4">
                <a href="<?php echo e(route('kontak')); ?>" class="w-full px-6 py-3 bg-white text-blue-700 font-bold rounded-xl text-center shadow-lg transition-all duration-300 hover:bg-blue-50 hover:scale-105">
                    Hubungi Kami
                </a>
                <div class="flex items-center space-x-4 mt-4">
                    ...
                    <a href="<?php echo e($social->link_platform); ?>" class="text-white hover:text-blue-200 transition-colors">
                        <img src="<?php echo e(asset('storage/' . $social->images->first()->image)); ?>" alt="<?php echo e($social->platform); ?>" class="w-7 h-7">
                    </a>
...
</script><?php /**PATH C:\Users\lenovo\Documents\cv_berkah_usaha\resources\views/components/home-components/navbar.blade.php ENDPATH**/ ?>