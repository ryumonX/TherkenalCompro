<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b">
            ...
            <a href="<?php echo e(route('admin.partner.create')); ?>"
                ...
                <tbody class="divide-y">
                    <?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-3">
                                <div class="font-medium text-gray-900"><?php echo e($partner->id); ?></div>
                            </td>
                            <td class="px-6 py-3">
                                <a href="#" onclick="showImagePreview('<?php echo e(asset('storage/' . $partner->image)); ?>', 'Partner ID: <?php echo e($partner->id); ?>'); return false;">
                                    <img src="<?php echo e(asset('storage/' . $partner->image)); ?>" alt="Partner Image"
                                         class="h-16 w-16 object-contain border rounded hover:border-indigo-500 cursor-pointer">
                                </a>
                            </td>
                            <td class="px-6 py-3">
                                <div class="font-normal text-gray-900"><?php echo e($partner->created_at->format('d M Y H:i')); ?></div>
                            </td>
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="<?php echo e(route('admin.partner.edit', $partner)); ?>"
                                       class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                    <form method="POST" action="<?php echo e(route('admin.partner.destroy', $partner)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Documents\TherkenalCompro\resources\views/admin/partner/index.blade.php ENDPATH**/ ?>