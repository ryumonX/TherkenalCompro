...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['kontak' => null]));
...
foreach (array_filter((['kontak' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
      ...
      <div class="bg-white rounded-2xl shadow-xl overflow-hidden relative">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 relative z-10">
            ...
            <div class="space-y-8 relative">
              ...
              <div class="flex items-start group">
                ...
                <div>
                  ...
                  <p class="text-blue-100"><?php echo e($kontak->alamat ?? 'Alamat belum tersedia'); ?></p>
                </div>
              </div>
              ...
              <div class="flex items-start group">
                ...
                <div>
                  ...
                  <p>
                    <a href="tel:<?php echo e($kontak->no_telepon ?? ''); ?>" class="text-blue-100 hover:text-white transition-colors">
                      <?php echo e($kontak->no_telepon ?? 'Nomor telepon belum tersedia'); ?>
              ...
              <div class="flex items-start group">
                ...
                <div>
                  ...
                  <p>
                    <a href="mailto:<?php echo e($kontak->email ?? ''); ?>" class="text-blue-100 hover:text-white transition-colors">
                      <?php echo e($kontak->email ?? 'Email belum tersedia'); ?>
              ...
              <div class="flex items-start group">
                ...
                <div>
                  ...
                  <p class="text-blue-100"><?php echo $kontak->jam_kerja ?? 'Jam kerja belum tersedia'; ?></p>
                </div>
              </div>
            </div>
            ...
            <div class="mt-12 pt-6 border-t border-white/20 relative">
              ...
              <div class="flex space-x-4">
                <?php $__empty_1 = true; $__currentLoopData = $socialMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e($social->link_platform); ?>" class="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
          ...
          <div class="lg:col-span-3 p-8 lg:p-12">
            ...
            <form action="<?php echo e(route('kirim-pesan')); ?>" method="POST" class="space-y-6">
              <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="mt-12 rounded-2xl overflow-hidden shadow-lg h-[400px]">
        <?php if(isset($kontak->embed_map) && !empty($kontak->embed_map)): ?>
...
<?php /**PATH D:\coding\Therkenal\therkenal\resources\views/components/home-components/form-kontak.blade.php ENDPATH**/ ?>